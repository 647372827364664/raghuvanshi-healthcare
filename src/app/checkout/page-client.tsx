...
import { ArrowLeft, CreditCard, MapPin, Shield, Phone, Lock, ShoppingBag, Wallet } from 'lucide-react';
...
export default function CheckoutPageContent() {
  ...
  const handleRazorpayPayment = async () => {
    ...
    try {
      if (process.env.NODE_ENV === 'development' || !process.env.NEXT_PUBLIC_RAZORPAY_KEY_ID) {
        // Demo mode - skip actual payment in development
        toast.loading('Processing payment...', { duration: 2000 });
        await new Promise(resolve => setTimeout(resolve, 2000));

        const demoPaymentResult = {
          razorpay_payment_id: 'demo_' + Math.random().toString(36).substring(7),
